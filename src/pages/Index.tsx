...
const products: Product[] = [
  ...
  { id: 17, name: 'Nike JA 2 WH', price: 10004, brand: 'Nike', color: 'Бежевый', image: sneakerImages[15], images: [sneakerImages[15], 'https://cdn.poehali.dev/projects/3daf642b-8f4f-41a0-bdee-d1123fc45986/files/ccf77b08-bca2-42bc-b177-bf50d72faabf.jpg', 'https://cdn.poehali.dev/projects/3daf642b-8f4f-41a0-bdee-d1123fc45986/files/5871e394-d933-47de-a0a5-af6651b74295.jpg'], priceFrom: true, description: 'Элегантная бежевая версия кроссовок Ja Morant.', features: ['Лёгкая конструкция', 'Отзывчивая подошва', 'Минималистичный дизайн', 'Для быстрых защитников'], sizes: ['8 US', '9 US', '10 US', '11 US'] },
