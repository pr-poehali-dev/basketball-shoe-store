    ...
    <div className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-orange-400 via-orange-300 to-orange-200">
      ...
      <div className="relative z-10 h-full flex flex-col justify-between md:justify-center px-4 pt-24 pb-8 md:pt-20 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-3 max-w-lg">
          <Button 
            size="default" 
            className="bg-black hover:bg-black/80 text-white font-inter font-semibold px-3.5 py-2 md:px-8 md:py-5 text-[10px] md:text-sm rounded-full shadow-lg hover:shadow-xl transition-all group w-full sm:w-auto"
          >
            Смотреть каталог
          ...
          <Button 
            size="default" 
            variant="outline"
            className="border-2 border-black/90 bg-transparent text-black hover:bg-white hover:text-black hover:border-black font-inter font-semibold px-3.5 py-2 md:px-8 md:py-5 text-[10px] md:text-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
          >
