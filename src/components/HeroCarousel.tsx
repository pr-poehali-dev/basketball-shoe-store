  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-orange-400 via-orange-300 to-orange-200">
      ...
      <div className="hidden md:flex absolute top-20 right-8 gap-3 z-30">
        <div className="text-center px-4 py-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg flex flex-col items-center justify-center">
          <Icon name="ShieldCheck" className="text-orange-400 mb-1" size={20} />
          <div className="text-black font-inter font-bold text-xs uppercase tracking-wide">Официальный</div>
          <div className="text-black font-inter font-bold text-xs uppercase tracking-wide">дилер</div>
        </div>
        
        <div className="text-center px-4 py-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg flex flex-col items-center justify-center">
          <Icon name="BadgeCheck" className="text-orange-400 mb-1" size={20} />
          <div className="text-black font-inter font-bold text-xs uppercase tracking-wide">100%</div>
          <div className="text-black font-inter font-bold text-xs uppercase tracking-wide">Оригинал</div>
        </div>
        
        <div className="text-center px-4 py-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg flex flex-col items-center justify-center">
          <Icon name="Award" className="text-orange-400 mb-1" size={20} />
          <div className="text-black font-inter font-bold text-xs uppercase tracking-wide">1 год</div>
          <div className="text-black font-inter font-bold text-xs uppercase tracking-wide">Гарантия</div>
        </div>
      </div>
      ...
      <div className="absolute top-[58%] -translate-y-1/2 left-4 flex flex-col gap-2.5 md:hidden z-20">
        <div className="text-center px-3 py-2 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-lg flex flex-col items-center">
          <Icon name="ShieldCheck" className="text-orange-400 mb-1" size={16} />
          <div className="text-black font-inter font-bold text-[10px] uppercase tracking-wide">Официальный</div>
          <div className="text-black font-inter font-bold text-[10px] uppercase tracking-wide">дилер</div>
        </div>
        
        <div className="text-center px-3 py-2 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-lg flex flex-col items-center">
          <Icon name="BadgeCheck" className="text-orange-400 mb-1" size={16} />
          <div className="text-black font-inter font-bold text-[10px] uppercase tracking-wide">100%</div>
          <div className="text-black/90 font-inter text-[9px] uppercase tracking-wide">Оригинал</div>
        </div>
        
        <div className="text-center px-3 py-2 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 shadow-lg flex flex-col items-center">
          <Icon name="Award" className="text-orange-400 mb-1" size={16} />
          <div className="text-black font-inter font-bold text-[10px] uppercase tracking-wide">1 год</div>
          <div className="text-black/90 font-inter text-[9px] uppercase tracking-wide">Гарантия</div>
        </div>
      </div>
